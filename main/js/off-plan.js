...
const data = [
  ...
  <div class="row">
      ...
      <i style="margin-left:5px" class="fa fa-map-marked"> ${data[i].type}</i></a>
  
  </div>
      <div style="margin-left: -5px; color:silver" class="row">
      ${data[i].developer}
      </div>
      <div style="border:1px solid #a1863d; height: 40px; line-height:40px; width:375px" class="row">
                    <div class="col">
                        <a style="color: silver;" href="#">${data[i].link}</a>
                    </div>
                    <div style="width: auto; height: auto;" class="col">
                        <a href=""><img style="width: 21px; height: 21px; margin-left: 80%;" src="../assets/images/svg/arrow.png"/></a>
                    </div>
                </div>
  ` ;
