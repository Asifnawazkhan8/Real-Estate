...
<body>
    ...
    <div style="background-color: black; width: auto;" class="container-fluid">
        ...
        <div style="margin-top: 10px;" class="row">
            <img style="border: 1px solid #a1863d; border-radius: 4px 2px ; box-shadow: 5px 5px 2px #a1863d; box-sizing: content-box;" src="../assets/images/blog-banner.jpg"/>
            <p style="color: #a1863d; text-align: center; margin-top: -7%; font-size: 4em;">VIXION CAPITAL BLOG</p>
            <p style="color: silver; text-align: center; margin-top: -2%; font-size: 2em;">Keep up to date with the latest developments with VIXION CAPITAL BLOG</p>
            
        
        </div>
        <div style="height: auto; width: auto;" class="row">
            <div style="background-color: black; " class="col">
                <a style="color: #a1863d;" href="../main/layout-10.html"><i data-feather="home"></i></a><p style="margin-top: -18px; margin-left: 30px;"> > VX BLOG</p>
                <div class="row">
   ...
   <div class="container">
        <div class="row">
            <h4 style="color: whitesmoke; text-align: center; margin-top: 2%;">VIXION CAPITAL BLOGS</h4>
        </div>
        <div style="margin-top: 5%;" class="row">
            <a href="">
           <div style="background-color: black; border: 1px solid #a1863d; margin-left: 10px; margin-right: 10px;" class="col">
                <div class="row">
                    <img src="../assets/images/property/blog1.jpg"/>
                </div>
                <div class="row">
                    <span style="font-size: large; color: #a1863d;">How to find ur agent in Dubai <br> Expert Advice</span>
                </div>
                <div class="row">
                    
                </div>
                <div style="margin-top: 80px;" class="row">
                    <p style="color: #a1863d;">July 2, 2023</p> <br>
                    <p style="color: #a1863d;">Real Estate</p>
                </div>
                <div style="border:1px solid #a1863d; height: 50px; line-height:40px;" class="row">
                    <div class="col">
                        <a style="color: silver;" href="#">EXPLORE</a>
                    </div>
                    <div style="width: auto; height: auto;" class="col">
                        <a href=""><img style="width: 21px; height: 21px; margin-left: 90%;" src="../assets/images/svg/arrow.png"/></a>
                    </div>
                </div>
           </div></a>
           <div style="background-color: black; border: 1px solid #a1863d; margin-left: 10px; margin-right: 10px;" class="col">
    ...
    <div style="border: 2px solid #a1863d; width: auto; height: auto; margin-top: 20px;" class="container">
        <div class="row">
            ...
            <div class="col">
                <div style="background-color: black;" class="wrapper">
                    <div style="background-color: black;" class="form">
                        ...
                        <input style="background-color: black; color: #a1863d;" type="number" placeholder="Your Phone"/>
                    </div>
                </div>    
            </div>
            <div class="col">
                    ...
                    <div class="col-xl-3">
                        <div class="footer-details text-center">
                            ...
                            <ul class="icon-list">
                                ...
                                <li><a href="../main/contact.html"><i class="fas fa-phone-alt"></i></a></li>
                                <li><a href="../main/contact.html"><i class="fas fa-envelope"></i></a></li>
                                <li><a href="../main/layout-10.html"><i class="fas fa-globe"></i></a></li>
                        ...
                        <div class="row">
                            <div class="col-lg-3 col-md-4">
                                <div class="footer-links footer-left-space">
                                    ...
                                    <ul class="footer-content">
                                        <li>
                                            <a href="../main/buy.html">Appartment</a>
                                        </li>
                                        <li>
                                            <a href="../main/buy.html">Penthouse</a>
                                        </li>
                                        <li>
                                            <a href="../main/buy.html">Villas</a>
                                        </li>
                                        <li>
                                            <a href="../main/buy.html">Townhouses</a>
                                        </li>
                                        <li>
                                            <a href="../main/off-plan.html">Off-Plan</a>
                                        </li>
                                        <li>
                            ...
                            <div class="col-lg-2 col-md-4">
                                <div class="footer-links">
                                    ...
                                    <ul class="footer-content">
                                        <li>
                                            <a href="../main/Catalog.html">Catalogs</a>
                                        </li>
                                        <li>
                                            <a href="agency-list.html">Area Guides</a>
                                        </li>
                                        <li>
                                            <a href="agent-grid.html">Vx Design</a>
                                        </li>
                                        <li>
                                            <a href="../main/sell.html">Sell</a>
                                        </li>
                                        <li>
                                            <a href="../main/rent.html">Rent</a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
