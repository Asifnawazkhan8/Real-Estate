...
<head>
    ...
    <meta name="description" content="Sheltos - Morden video home page">
...
<body>
    ...
    <div style="background-color: black; width: auto;" class="container-fluid">
    
        <div style="margin-top: 10px;" class="row">
            <img style="border: 1px solid #a1863d; border-radius: 4px 2px ; box-shadow: 5px 5px 2px #a1863d; box-sizing: content-box;" src="../assets/images/banner-2.jpeg"/>
            <p style="color: #a1863d; text-align: center; margin-top: -8%; font-size: 5em;">Sell</p>
            <p style="color: silver; text-align: center; margin-top: -1%; font-size: 2em;">Deal assistance in the best performance</p>
        ...
        <div style="height: auto; width: auto;" class="row">
            <div style="background-color: black; " class="col">
                <div class="row">
                    <div class="col">
                        <h4 style="color: #a1863d; margin-top: 10%;">NEED A SOLUTION?</h4>
                        <h6 style="color: whitesmoke; margin-top: 0%;">MOST WELL INFORMED</h6>
                        <h6 style="color: whitesmoke; margin-top: 0%;">SPECIALIST WILL DO IT FOR YOU</h6>
                    </div>    
                </div>
                    <div class="row">
                        <div class="col">
                ...
                <div style="background-color: black;" class="col">
                    <p style="font-size: 28sp;margin-top: 8%; color: #a1863d;">AX CAPITAL is an experienced assistant in sales. With our help,<br> you can quickly and profitably sell your property and find suitable <br> buyers. A vast amount of knowledge allows our specialists to feel <br> the market and find the best real estate solutions.</p>
                    <div class="row">
                        <div class="col">
                            <button style="width: 40%; height: 60px; margin-top: 8%; background-color: black; border: 1px solid #a1863d; color: #a1863d; border-radius: 5px 5px 3px;">ENQUIRE NOW</button>
                            </div>
                        </div>    
                    </div>
                </div>
   ...
   <div class="container">
        <div class="row">
            <h4 style="color: whitesmoke; text-align: center; margin-top: 6%;">PREPARATION STATE</h4>
        </div>
        <div style="margin-top: 5%;" class="row">
            <div style="background-color: black; border: 0.5px solid silver; margin-left: 15px; border-radius: 4px 2px;" class="col">
                <h4 style="color: #a1863d; margin-top: 10%;">AN HONEST
                    <br>OPINION</h4>
                <h6 style="color: whitesmoke; margin-top: 0%; margin-left: 5px;">Full transparency and straight to the point communication.</h6>
            </div>
            <div style="background-color: black; border: 0.5px solid silver; margin-left: 15px; border-radius: 4px 2px;" class="col">
                <h4 style="color: #a1863d; margin-top: 10%;">KNOWLEDGE
                    <br>& EXPERTISE</h4>
                <h6 style="color: whitesmoke; margin-top: 0%; margin-left: 5px;">Great sense of the market to negotiate the best possible deal.</h6>
            </div>
            <div style="background-color: black; border: 0.5px solid silver ; margin-left: 15px; border-radius: 4px 2px ;" class="col">
                <h4 style="color: #a1863d; margin-top: 10%;">SERVICE
                    <br> FOR EVERYONE</h4>
                <h6 style="color: whitesmoke; margin-top: 0%; margin-left: 5px;">Equal service for any budget and price point to deal with.</h6>
            </div>
        </div>
        <div class="row">
            <h3 style="color: whitesmoke; margin-top: 10%; text-align: center;">OUR SERVICES</h3>
        </div>
        <div style="margin-top: 5%;" class="row">
            <div style="color:#a1863d;" class="col">
            <img style="width: 530px; height: 400px;" src="../assets//images/vd.jpeg"/>
            <p style="color: rgb(216, 216, 216); margin-top: -15%; font-size: large; margin-left: 8px;">VIDEOGRAPHY</p>
            <p style="color: rgb(214, 214, 214); margin-top: -3%; font-size: small; margin-left: 8px; margin-right: 8.5px;">We have a divine videographer. Everything that we capture on camera is polished to the top-notch level.</p>
            <p style="color: #CFB53B;  margin-top: -2%; font-size: large; margin-left: 8px;">Experience Vixion Capital Videos</p>

            </div>
            <div style="color: #a1863d;" class="col">
            <img style="width: 530px; height: 400px;" src="../assets/images/pt.jpeg"/>
            <p style="color: rgb(216, 216, 216); margin-top: -15%; font-size: large; margin-left: 8px;">PHOTOGRAPHY</p>
            <p style="color: rgb(214, 214, 214); margin-top: -3%; font-size: small; margin-left: 8px; margin-right: 8.5px;">Just like you wouldn't go to a job interview without proper outfit, photography is critical to setting record sale and rental prices, we do it better than anyone.</p>
            <p style="color: #CFB53B;  margin-top: -2%; font-size: large; margin-left: 8px;">Experience Vixion Capital Photos</p>
        </div>
        </div>
    </div>
    <div style="border: 1px solid #a1863d; width: auto; height: auto; margin-top: 120px; border-radius: 10px;" class="container">
        <div class="row">
            <h3 style="color: #a1863d; text-align: center; margin-top: 100px;">PROMPT CONSULTATION</h3>
            <h5 style="color: #a1863d; text-align: center;">Fill form below and our agent will contact you shortly</h5>
        </div> 
        <div style="margin-top: 50px;" class="row">
            <div class="col">
                <div style="background-color: black;" class="wrapper">
                    <div style="background-color: black;" class="form">
            
                        <input style="background-color: black; color: #a1863d;" type="text" placeholder="Your Name"/>
                    </div>
                </div>    
            </div>
            <div class="col">
                <div style="background-color: black;" class="wrapper">
                    <div style="background-color: black;" class="form">
                        ...
                        <input style="background-color: black; color: #a1863d;" type="text" placeholder="Your Phone"/>
                    </div>
                </div>    
            </div>
            <div class="col">
                <div style="background-color: black;" class="wrapper">
                    <div style="background-color: black;" class="form">
                        ...
                        <input style="background-color: black; color: #a1863d;" type="email" placeholder="Your Email"/>
                    </div>
                </div>    
            </div>
            <div style="margin-top: 0px;" class="col">
                <button style="width: 95%; height: 90%; font-size:large; border: 1px solid #a1863d; border-radius: 5px 5px 10px; background-color: black; color: #a1863d;">Send</button>
                </div>    
            </div>        
            <div style="margin-top: 20px;" class="row">
                <h6 style="text-align: center; color: rgb(201, 201, 201);">Or contact us right now via
                    <a style="color:#a1863d;" href="https://web.whatsapp.com/"><i class="fa fa-phone-square"></i> WhatsApp</a></h6>
            </div> 
        </div>
    ...
    <div style="margin-top: 10%; border: 1px solid #a1863d;" class="container-fluid">
        <div class="row">
            <div style="" class="col">
                <img src="../assets//images/logo/1.png"/>
            </div>
            <div style="background-color: black;" class="col">
                <h6 style="color: #a1863d; text-align: right; margin-top:40px;">CONTACTS</h6>
            </div>
        </div>
    </div>
    ...
    <!-- Color-picker js-->
    <script src="../assets/js/color/layout10.js"></script>
