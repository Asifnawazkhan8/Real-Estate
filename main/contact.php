...
<head>
    ...
    <meta name="description" content="Sheltos - Contact page 3">
    ...
    <title>VIXION CAPITAL - Contact page</title>
...
<body>
                            ...
                            <div class="main-navbar">
                                <div id="mainnav">
                                    ...
                                    <ul class="nav-menu">
                                        ...
                                        <li class="dropdown">
                                            <a href="../main/buy.html" class="nav-link menu-title">Buy</a>
                                            
                                        </li>
                                        <li class="dropdown">
                                            <a href="../main/rent.html" class="nav-link menu-title">Rent</a>
                                            
                                        </li>
                                        <li class="dropdown">
                                            <a href="../main/sell.html" class="nav-link menu-title">Sell</a>
                                           
                                        </li>
                                        <li class="mega-menu">
                                            <a href="../main/off-plan.html" class="nav-link menu-title">
                                                Off-Plan
                                            </a>
                                            </li>
                                        <li class="dropdown">
                                            <a href="../main/vx-blog.html" class="nav-link menu-title">Vx Blog</a>
                                            <ul style="background-color:black; width: auto; " class="nav-submenu menu-content">
                                                <li><a style="color: #CFB53B;" href="../main/news.html">News</a>
                                                </li>
                                                <li><a style="color: #CFB53B;" href="../main/podcast.html">Podcasts</a>
                                                </li>
                                            </ul>
                                        <li class="dropdown">
                                            <a href="../main/Catalog.html" class="nav-link menu-title">Catalogs</a>
                                            
                                        </li>
                                        <li class="dropdown">
                                            <a href="../main/who.html" class="nav-link menu-title">Who We Are</a>
                        ...
                        <ul class="header-right">
                            ...
                            <li>
                                <div style="width: auto;" class="dropdown">
                                    ...
                                    <div style="background-color: black; width: auto;" class="dropdown-content">
                                        <a style="color: #CFB53B;" href="../back-end/index.html">Dashboard</a>     
                                    <a style="color: #CFB53B;" href="#">Sign Up</a>
                                    <a style="color:#CFB53B;" href="#">Log In</a>
                            ...
                            <li style="width: auto;">
                                <a style="color: #CFB53B;" href="../main/contact.html"><i style="color: #CFB53B;" data-feather="phone"></i> Contact Us</a>
                            </li>
    ...
    <section class="breadcrumb-section p-0">
        <img src="../assets/images/contact.jpg" class="bg-img img-fluid" alt="">
        <div class="container">
                        ...
                        <form class="row gx-3 get-in-touch">
                                ...
                                <div class="input-group">
                                    <div class="input-group-prepend">
                                        <div class="input-group-text">
                                            <i style="color: #CFB53B;" data-feather="user"></i>
                                        </div>
                                    </div>
                            ...
                            <div class="form-group col-md-6">
                                <div class="input-group">
                                    <div class="input-group-prepend">
                                        <div class="input-group-text">
                                            <i style="color: #CFB53B;" data-feather="phone"></i>
                                        </div>
                                    </div>
                                    <input 
                            ...
                            <div class="form-group col-md-6">
                                <div class="input-group">
                                    <div class="input-group-prepend">
                                        <div class="input-group-text">
                                            <i style="color: #CFB53B;" data-feather="mail"></i>
                                        </div>
                                    </div>
                    ...
                    <div class="row">
                        <div class="col-lg-12 col-sm-6">
                            <div class="contact_wrap">
                                <i style="color: #CFB53B;" data-feather="map-pin"></i>
                                <h4 style="color: #CFB53B;">OFFICE ADDRESS</h4>
                                <p style="color: silver;" class="font-roboto"> 17th floor,Office 1707, Opal Tower,
                        ...
                        <div class="col-lg-12 col-sm-6">
                            <div class="contact_wrap">
                                <i style="color: #CFB53B;" data-feather="mail"></i>
                                <h4 style="color: #CFB53B;">Online service</h4>
                               <p style="color: silver;">Email: info@vixioncapital.ae
                                <br>website: www.vixioncapital.ae </p>
                            </div>
                        </div>
                    </div>
                </div>
