...
<body style="background-color: black;">
    ...
    <div style="background-color: black; width: auto;" class="container-fluid">
        ...
        <div style="margin-top: 10px;" class="row">
            <img style="border: 1px solid #a1863d; border-radius: 4px 2px ; box-shadow: 5px 5px 2px #a1863d; box-sizing: content-box;" src="../assets/images/Off-Plan.jpg"/>
            <p style="color: #a1863d; text-align: center; margin-top: -7%; font-size: 4em;">OFF-PLAN IN DUBAI</p>
            <p style="color: silver; text-align: center; margin-top: -2%; font-size: 2em;">New top-launched projects</p>
    ...
    <!-- customizer end -->
    <script src="../main/js/off-plan.js"></script>
