...
<body style="background-color: black;">
    ...
    <div style="background-color: black; width: auto;" class="container-fluid">
        ...
        <div style="margin-top: 10px;" class="row">
            ...
            <div class="col" style="background-color:green; height:500px;">Khan</div>
            <div class="col" style="background-color:blue; height:500px;">Khan</div>
            <div class="col" style="background-color:maroon; height:500px;">Khan`</div>
            <div class="col" style="background-color:indigo; height:500px;">Khan</div>
        
            <p style="color: #a1863d; text-align: center; margin-top: -7%; font-size: 4em;">WHO WE ARE</p>
            <p style="color: silver; text-align: center; margin-top: -2%; font-size: 2em;">GET TO KNOW OUR TEAM</p>
        ...
        <div style="height: auto; width: auto;" class="row">
            <div style="background-color: black; " class="col">
                <a style="color: #a1863d;" href="../main/layout-10.html"><i data-feather="home"></i></a><p style="margin-top: -18px; margin-left: 30px;"> > Property</p>
                <div class="row">
                       
                </div>
                    <div class="row">
                        <div class="col">
                            <img style="margin-top: 10%;" src="../assets/images//logo/1.png"/>
                            </div>
                        </div>    
                    </div>
                <div style="background-color: black;" class="col">
                    <p style="font-size: 28sp;margin-top: 15%; color: #a1863d;">VIXION CAPITAL is an experienced assistant in sales. With our help,<br> you can quickly and profitably sell your property and find suitable <br> buyers. A vast amount of knowledge allows our specialists to feel <br> the market and find the best real estate solutions.</p>
                    <div class="row">
                        <div class="col">
   ...
   <div class="container">
        <div class="row">
            <h4 style="color: whitesmoke; text-align: center; margin-top: 6%;">OFF-PLAN</h4>
        </div>
        <div style="margin-top: 5%;" class="row">
           <div style="background-color: black; margin-right: 8px;" class="col">
                <div class="row">
                    <img src="../assets/images/property/1.webp"/>
                </div>
                <div class="row">
                    <span style="font-size: large; color: #a1863d;">Sls Residences Palm</span>
                </div>
                <div class="row">
                    <p style="color: #a1863d;">Type: Residential</p>
                </div>
                <div class="row">
                    <p style="color: #a1863d;">Developer: Roya Lifestyle Development</p>
                </div>
                <div class="row">
                    <a style="color: silver; margin-top: 5px;" href="#">EXPLORE</a>
                </div>
           </div>
           <div style="background-color: black; margin-left: 4px; margin-right: 4px;" class="col">
            <div class="row">
                <img src="../assets/images/property/1.webp"/>
            </div>
            <div class="row">
       ...
       <div style="background-color: black; margin-left: 8px;" class="col">
            <div class="row">
                <img src="../assets/images/property/1.webp"/>
            </div>
            <div class="row">
    ...
    <div style="border: 1px solid #a1863d; width: auto; height: auto; margin-top: 40px; border-radius: 10px;" class="container">
        <div class="row">
