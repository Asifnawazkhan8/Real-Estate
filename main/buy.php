...
<head>
    ...
    <meta name="description" content="VIXION CAPITAL - Morden video home page">
    <meta name="keywords" content="VIXION CAPITA">
    <meta name="author" content="VIXION CAPITA">
...
<body style="background-color: black;">
    ...
    <!--Head med-->
    <div style="background-color:transparent; height: 80%; margin-top: 3%;" class="container-fluid">
        <video style="width: auto; height: 750px; margin-left: -5px; border: 1px solid #a1863d; border-radius: 10px;" class="bgvideo" playsinline="" autoplay="" muted="" loop="">
            <source style="height: 300px;" src="../assets/video/dubai2.mp4" type="video/mp4">
        </video>
        <p style="text-align: right; margin-top: -3%; color: silver;">VIXION CAPITAL</p>
    </div>
    <!--head below med-->
    <div style="background-color: black; width: auto; margin-top: 2%;" class="container-fluid">
        <div style="background-color: transparent;" class="row"></div>
        <div class="row">
            <div style="width: auto; height: auto;" class="col">
                <ul>
                <li>
                    <a style="color: #a1863d;" href="layout-10.html"><i style="margin-top: -8px; width: auto;" data-feather="home"> </i></a><span style="color: #a1863d;">  >  All Properties </span>
        ...
        <div style="height: auto; width: auto;" class="row">
            <h2 style="text-align: center; margin-top: 80px; color: #a1863d;">PROPERTIES FOR SALE IN DUBAI</h2>
        </div>
        <div style="height: auto; width: auto;" class="row">
            <div class="menu">
                ...
                <nav>
                    <div class="main-navbar">
                                ...
                                <li class="dropdown">
                                    <a style="color: #a1863d;" href="#" class="nav-link menu-title">Appartments (0)</a>
                                
                                </li>
                                <li class="dropdown">
                                    <a style="color: #a1863d;" href="#" class="nav-link menu-title">Villas (0)</a>
                                    
                                </li>
                                <li class="dropdown">
                                    <a style="color: #a1863d;" href="#" class="nav-link menu-title">Townhouses (0)</a>
                               
                                </li>
                                <li class="mega-menu">
                                    <a style="color: #a1863d;" href="javascript:void(0)" class="nav-link menu-title">
                                        penthouses (0)
                                    </a>
                                    </li>
                                <li class="dropdown">
                                    <a style="color: #a1863d;" href="javascript:void(0)" class="nav-link menu-title">Duplexes (0)</a>
                                <li class="dropdown">
                                    <a style="color: #a1863d;" href="javascript:void(0)" class="nav-link menu-title">Plots (0)</a>
                                
                                </li>
                                <li class="dropdown">
                                    <a style="color: #a1863d;" href="javascript:void(0)" class="nav-link menu-title">Hotel Appartments (0)</a>
                                
                                </li>
                                <li class="dropdown">
                                    <a style="color: #a1863d;" href="javascript:void(0)" class="nav-link menu-title">Commercial Properties (0)</a>
   ...
   <div style="background-color: black;" class="container-fluid">
        ...
        <div style="background-color: black; width: auto; height: auto; margin-left: 10px; margin-right:10px; display:grid;" class="row">
            <div id="img" style="width: auto; height: auto; display:grid;  grid-template-columns: repeat(3, 1fr); grid-gap: 10px;" class="col" id="data">
            </div>
        ...
        <div class="row">
                ...
                <nav style="text-align:center;"  class="theme-pagination">
                        <ul id="demo" class="pagination">
                            <!-- <li class="page-item">
                                <a style="background-color: black; width:80px;" class="page-link" href="" aria-label="Previous">
                                    <span aria-hidden="true">«</span>
                                    <span class="sr-only">Previous</span>
                                </a>
                            </li>
                            <li class="page-item"><a style="background-color: black; width:80px;" class="page-link" href="">1</a></li>
                            <li class="page-item"><a style="background-color: black; width:80px;" class="page-link" href="">2</a></li>
                            <li class="page-item active"><a style="background-color: black; width:80px;" class="page-link" href="">3</a></li>
                            <li class="page-item"><a style="background-color: black; width:80px;" class="page-link" href="">4</a></li>
                            <li class="page-item"><a style="background-color: black; width:80px;" class="page-link" href="">5</a></li>
                            <li class="page-item">
                                <a style="background-color: black; width:80px;" class="page-link" href="" aria-label="Next">
                                    <span  aria-hidden="true">»</span>
    ...
    <div style=" background-color: black ;border: 1px solid #a1863d; width: auto; height: auto; margin-top: 20px; border-radius: 10px;" class="container">
        <div class="row">
            ...
            <form  onsubmit="sendEmail(); reset(); return false;">
                <div style="background-color: black;" class="wrapper">
                    <div style="background-color: black;" class="form">
                        ...
                        <input style="background-color: black; color: #a1863d;" type="text" id="name" placeholder="Your Name" required/>
                ...
                <div class="col">
                    <div style="background-color: black;" class="wrapper">
                        <div style="background-color: black;" class="form">
                            ...
                            <input style="background-color: black; color: #a1863d;" type="text" id="phone" placeholder="Your Phone" required/>
                        </div>
                    </div>    
                </div>
                <div class="col">
                    <div style="background-color: black;" class="wrapper">
                        <div style="background-color: black;" class="form">
                            ...
                            <input style="background-color: black; color: #a1863d;" type="email" id="email" placeholder="Your Email" required/>
                        </div>
                    </div>    
                </div>
                    <div style="margin-top: 0px;" class="col">
                    <button type="submit" style="width: 95%; height: 90%; font-size:large; border: 1px solid #a1863d; border-radius: 5px 5px 10px; background-color: black; color: #a1863d;">Send</button>
...
function sendEmail() {
    ...
    Email.send({
        Host : "smtp.info@vixioncapital.ae",
        Username : "Asifnawazkhan8@gmail.com",
        Password : "",
        To : 'info@vixioncapital.ae',
      ...
      message => alert("Messege send successfully")
            ...
            <div style="margin-top: 20px;" class="row">
                <p style="text-align: center; color: rgb(201, 201, 201); font-size: 1em;">Or contact us right now via
                    <a style="color:#a1863d;" href="https://web.whatsapp.com/"><i class="fa fa-phone-square"></i> WhatsApp</a></p>
            </div>         
        </div>        
    ...
    <!-- customizer end -->
      <script src="../main/js/buy.js"></script>   
