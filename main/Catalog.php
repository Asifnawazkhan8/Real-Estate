...
<body>
    ...
    <div style="background-color: black; width: auto;" class="container-fluid">
        ...
        <div style="margin-top: 10px;" class="row">
            <img style="border: 1px solid #a1863d; border-radius: 10px 10px 5px; box-sizing: content-box ;" src="../assets/images/catalogs.jpeg"/>
            <span style="color: #a1863d; text-align: center; margin-top: -10%; font-size: 4em;">Catalogs</span>
            <p style="color: silver; text-align: center; margin-top: -4%; font-size: 1.5em;">Dubai real estate selection</p>
