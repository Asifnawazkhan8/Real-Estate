...
<body>
    ...
    <div style="background-color: black; width: auto;" class="container-fluid">
        ...
        <div style="margin-top: 10px;" class="row">
            <img style="border: 1px solid #a1863d; border-radius: 10px 10px 5px; box-sizing: content-box ;" src="../assets/images/news.webp"/>
            <span style="color: #e4bc4e; text-align: center; margin-top: -9%; font-size: 4em;">VIXION CAPITAL NEWS</span>
            <p style="color: white; text-align: center; margin-top: -3%; font-size: 1.5em;">News about life and real estate in Dubai </p>
            
        
        </div>
        <!--body head-->
        <div style="background-color: black; margin-top: 10px;" class="container-fluid">
          <div style="background-color: black; margin: 8px; padding: 10px; " class="row">
                <div style="width: 300px; border: 1px solid silver; border-radius: 5px 4px; margin-right: 10px; margin-left: 10px; margin-bottom: 5px;" class="col">
                    <div style="width: 400px; height: auto; background-color: black; " class="row">
                        <span style="color: silver;font-size: 2em; margin: 20px;">Best Emaar Offers</span>
                    </div>
                    <div style="width: 400px; height: auto; background-color: black;" class="row">
                        <span style="color: silver; font-size: 1em;">TOP 10 PROJECTS FROM DUBAI LEADING DEVELOPER</span>
                    </div>
                    <div style="width: 400px; height: auto; background-color: black;" class="row">
                            <div style="margin-top: 20px;" class="col"><p style="color: #a1863d;">DOWNLOAD</p></div>
                        
                            <div style="margin-top: 20px;" class="col"><p style="text-align: right; color: #a1863d;">PREVIEW</p></div>
                    </div>
                    <div style="width: auto;" class="row">
                        <img style="width: 420px; height: 500px; padding: auto;" src="../assets/images/emar.jpeg"/>
        ...
        <div style="height: auto; width: auto;" class="row">
                ...
                <h3 style="color: #a1863d; text-align: center; margin-top: 10%;"> EXPERT REAL ESTATE INSIGHTS </h3>
                <p style="color: whitesmoke; text-align: center; margin-top: 1%; font-size: 1.1em;">Discover the insider knowledge of Dubai real estate from our agents: expert analysis and in-depth information on the city and its property <br><br> market.</p>
        </div>
   ...
   <div style="margin-top: 20px;" class="container">
        <div class="row">
           <div style="background-color: black;" class="col">
                <img style="width: 95%; height: 95%;" src="../assets/images/blog/podcast.jpg"/>
            </div>
           <div style="background-color: black;" class="col">
            <h3 style="color: #a1863d; margin-top: 20%; margin-left: 20px;">VIXION CAPITAL </h3>
            <p style="color: whitesmoke; text-align: center; margin-top: 2%; font-size:1em; margin-left: 10px;">Listen to podcasts from our real estate agents and stay up to date on the <br> dubai Property Market: Latest News: Expert Advice and many more...</p>
               <a href="../main/podcast.html"><button style="border: 1px solid #a1863d;width: 150px; height: 50px; margin-left: 25px; background-color: black; border-radius: 4px;color: #a1863d; margin-top: 20px;">ALL PODCASTS</button></a>
            </div>
        </div>
        
    <div style="border: 2px solid #a1863d; width: auto; height: auto; margin-top: 120px;" class="container">
        <div class="row">
