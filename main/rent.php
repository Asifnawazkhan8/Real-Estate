...
<body style="background-color: black;">
    ...
    <div style="background-color:transparent; height: 80%; margin-top: 3%;" class="container-fluid">
        <video style="width: auto; height: 750px; margin-left: -5px; border: 1px solid #a1863d; border-radius: 10px;" class="bgvideo" playsinline="" autoplay="" muted="" loop="">
            <source style="height: 300px;" src="../assets/video/dubai1.mp4" type="video/mp4">
        </video>
    ...
    <div style="background-color: black; width: auto;" class="container-fluid">
        ...
        <div style="height: auto; width: auto; background-color: black;" class="row">
            <h2 style="text-align: center; margin-top: 80px; color: #a1863d;">PROPERTIES FOR RENT IN DUBAI</h2>
        </div>
        <div style="height: auto; width: auto;" class="row">
            <div class="menu">
            
                <nav>
                    <div style="margin-left: 25%;" class="main-navbar">
    ...
    <div style="background-color: black; width: auto; height: auto; margin-left: 10px; margin-right:10px; display:grid;" class="row">
            <div style="width: auto; height: auto; display:grid;  grid-template-columns: repeat(3, 1fr); grid-gap: 10px;" class="col" id="data">
            </div>
    ...
    <div style="border: 1px solid #a1863d; width: auto; height: auto; margin-top: 20px; background-color: black; border-radius: 10px;" class="container">
        <div class="row">
    ...
    <!-- customizer end -->
    <script src="../main/js/rent.js"></script>
