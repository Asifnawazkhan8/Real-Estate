...
<head>
    ...
    <meta name="description" content="Sheltos - Our Service page">
    <meta name="keywords" content="sheltos">
    <meta name="author" content="sheltos">
    <link rel="icon" href="../assets/images/favicon.png" type="image/x-icon" />
    <title>Sheltos - Our Service page</title>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col mega-box">
                                                            ...
                                                            <div class="link-section">
                                                                ...
                                                                <div class="submenu-content opensubmegamenu">
                                                                    <ul class="list">
                                                                        <li><a href="../email-template/offer.html">Offer</a></li>
                                                                        <li><a href="../email-template/confirmation.html">Confirmation</a></li>
                                                                        <li><a href="../email-template/thankyou.html">Thank you</a></li>
                                                                    </ul>
                                                                </div>
                                                            </div>
                                                            <div class="link-section">
            ...
            <div class="row">
                ...
                <div class="col-lg-5">
                    <div class="provide-details">
                        ...
                        <button onclick="document.location='pricing.html'" type="button" class="btn btn-gradient color-2 btn-pill">Learn more <i class="fas fa-arrow-right ms-1"></i></button>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="blog-2 blog-grid">
                        <div>
                            <div class="blog-wrap">
                                <div class="blog-image">
                                    <div>
                                        <img src="../assets/images/blog/1.jpg" class="bg-img img-fluid" alt="">
                                    </div>
                                ...
                                <div class="blog-details">
                                    ...
                                    <p class="font-roboto">Residences can be classified by and how they are connected to neighbouring residences and land. Different types of housing tenure can be used for the same physical type. </p>
                        ...
                        <div>
                            <div class="blog-wrap">
                                <div class="blog-image">
                                    <div>
                                        <img src="../assets/images/blog/2.jpg" class="bg-img img-fluid" alt="">
                                    </div>
                                    <div class="blog-label">
                                        <div>
                                            <h3>10</h3>
                                ...
                                <div class="blog-details">
                                    ...
                                    <p class="font-roboto">Sometimes complemented by advice. Decoration is the furnishing of a space with decorative elements, sometimes complemented and practical assistance. </p>
                                    <a href="blog-detail-left-sidebar.html">read more</a>
                                </div>
                            </div>
                        </div>
                        <div>
                            <div class="blog-wrap">
                                <div class="blog-image">
                                    <div>
                                        <img src="../assets/images/blog/3.jpg" class="bg-img img-fluid" alt="">
                                    </div>
                                    <div class="blog-label">
                                        <div>
                                            <h3>21</h3>
                                ...
                                <div class="blog-details">
                                    ...
                                    <p class="font-roboto">Decoration is the furnishing of a space with decorative elements, sometimes complemented by advice. sometimes complemented and practical assistance.</p>
                                    <a href="blog-detail-left-sidebar.html">read more</a>
                                </div>
                            </div>
                        </div>
                        <div>
                            <div class="blog-wrap">
                                ...
                                <div class="blog-details">
                                    ...
                                    <p class="font-roboto">Luxury real estate is sometimes use as store value, especially wealthy foreigners, without any particular attempt to rent. Some luxury units in London and New York City. </p>
                                    <a href="blog-detail-left-sidebar.html">read more</a>
                                </div>
                            </div>
                        </div>
